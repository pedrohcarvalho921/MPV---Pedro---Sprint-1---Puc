...
# IMPORTANTE: Dado que esse arquivo representa os logs da aplicação - Não mexi nesse arquivo para não criar nenhum tipo de problema durante a correção da aplicação. Atenciosamente, Pedro.
